...
// 1. Declarando las rutas de los componentes de Angular e importar las librerías
const routes: Routes = [
  { path: '', component: HomeComponent }, //vacío = home
  ...
  // 1.1 Redireccionando a la ruta 'home' cuando no exista la ruta
  { path: '**', redirectTo: '', pathMatch: 'full' }, //redictTo vacío = home

  // 1.2 ir a app.component.html a agregar las rutas en el navbar
